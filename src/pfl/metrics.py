...
from datasets.dataloader import FederatedDataloader
...
def compute_metrics_from_global_model(
    ...
    for client_id in list_of_clients:
        ...
        client_size, metrics_for_client = compute_metrics_for_client(
            global_model, client_dataloader, metrics_of_batch_fn, temperature=temperature
        )
...
def compute_metrics_for_client(
        model, client_dataloader, metrics_of_batch_fn, temperature=None, map_labels=None
):
