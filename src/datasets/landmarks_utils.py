...
FED_GLD_SPLIT_FILE_DOWNLOAD_URL = 'http://storage.googleapis.com/gresearch/federated-vision-datasets/%s.zip' \
...
def _create_federated_gld_dataset(
        ...
        test_mapping_file: str) -> Tuple[CustomClientData, tf.data.Dataset]:
    """
...
def _create_mini_gld_dataset(
        cache_dir: str, image_dir: str) -> Tuple[CustomClientData, tf.data.Dataset]:
...
) -> Tuple[CustomClientData, tf.data.Dataset, CustomClientData, tf.data.Dataset]:
    """
